...
export function dieFace(value) {
  const dots = {
    1: '<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:10px;height:10px;background:var(--die-dot-color);border-radius:50%"></div>',
    2: '<div style="position:absolute;top:20%;left:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;bottom:20%;right:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div>',
    3: '<div style="position:absolute;top:20%;left:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;bottom:20%;right:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div>',
    4: '<div style="position:absolute;top:20%;left:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;top:20%;right:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;bottom:20%;left:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;bottom:20%;right:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div>',
    5: '<div style="position:absolute;top:20%;left:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;top:20%;right:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;bottom:20%;left:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;bottom:20%;right:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div>',
    6: '<div style="position:absolute;top:20%;left:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;top:20%;right:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;top:50%;left:20%;transform:translateY(-50%);width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;top:50%;right:20%;transform:translateY(-50%);width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;bottom:20%;left:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div><div style="position:absolute;bottom:20%;right:20%;width:8px;height:8px;background:var(--die-dot-color);border-radius:50%"></div>'
  };
  return dots[value] || '';
}
